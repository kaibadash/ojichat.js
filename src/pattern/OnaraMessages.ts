    ...
    public static selectTemplate(emotion: OjisanEmotion): string {
        ...
        switch (emotion) {
            ...
            case OjisanEmotion.Question:
                ...
                break;
            case OjisanEmotion.Reporting:
                messages = ["今日は{LOCATION}28度だよ{EMOJI_NEG}暑いよ{EMOJI_NEG}ヤケドしないように気をつけないとね{EMOJI_POS}",
        ...
        return _.shuffle<string>(messages)[0];
    }
}